...
#define TAG_ID_GET_VOLTAGE 0x00030003

typedef struct _MAILBOX_GET_VOLTAGE
{
	MAILBOX_HEADER Header;
	ULONG VoltageId;
	ULONG Value;
...
__inline VOID INIT_MAILBOX_GET_VOLTAGE (
	_Out_ MAILBOX_GET_VOLTAGE* PropertyMsgPtr,
	_In_  ULONG VoltageId)
{
	PropertyMsgPtr->Header.TotalBuffer = sizeof(MAILBOX_GET_VOLTAGE);
	PropertyMsgPtr->Header.RequestResponse = TAG_REQUEST;
	PropertyMsgPtr->Header.TagID = TAG_ID_GET_VOLTAGE;
	PropertyMsgPtr->Header.ResponseLength = 8;
	PropertyMsgPtr->Header.Request = TAG_REQUEST;
	PropertyMsgPtr->VoltageId = VoltageId;
	PropertyMsgPtr->Value = 0;
	PropertyMsgPtr->EndTag = 0;
}

#define MAILBOX_VOLTAGE_ID_CORE    0x000000001
#define MAILBOX_VOLTAGE_ID_SDRAM_C 0x000000002
#define MAILBOX_VOLTAGE_ID_SDRAM_P 0x000000003
#define MAILBOX_VOLTAGE_ID_SDRAM_I 0x000000004
